...
let s:tab_sel_fg = s:palette.grey2
let s:tab_sel_bg = s:palette.bg0
let s:tab_middle_fg = s:palette.grey1
let s:tab_middle_bg = s:palette.bg2
...
let s:insert_middle_bg = s:palette.bg2
...
let s:visual_middle_bg = s:palette.bg2
...
let s:replace_middle_bg = s:palette.bg2
...
let s:command_middle_bg = s:palette.bg2
