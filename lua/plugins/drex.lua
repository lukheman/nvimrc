...
require("drex.config").configure({
	...
	keybindings = {
		["n"] = {
			...
			["<cr>"] = { '<cmd>lua require("drex.elements").expand_element()<CR>', { desc = "expand element" } },
			...
			-- ["/"] = { '<cmd>lua require("drex.actions.search").search()<CR>', { desc = "search" } },
...
vim.keymap.set("n", "<c-n>", "<cmd>DrexDrawerToggle<cr>")
vim.keymap.set("n", "<leader>s", "<cmd>DrexDrawerFindFileAndFocus<cr>")
