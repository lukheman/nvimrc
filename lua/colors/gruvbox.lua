...
hl('TSPunctDelimiter', 'Delimiter')
hl('TSPunctBracket', 'Delimiter')
hl('TSPunctSpecial', 'Delimiter')
hl('TSConstant', 'Constant')
hl('TSConstBuiltin', 'Special')
hl('TSConstMacro', 'Define')
hl('TSString', 'String')
hl('TSStringRegex', 'String')
hl('TSStringEscape', 'SpecialChar')
hl('TSCharacter', 'Character')
hl('TSNumber', 'Number')
hl('TSBoolean', 'Boolean')
hl('TSFloat', 'Float')
hl('TSFunction', 'Function')
hl('TSFuncBuiltin', 'Special')
hl('TSFuncMacro', 'Macro')
hl('TSParameter', 'Identifier')
hl('TSParameterReference', 'TSParameter')
hl('TSMethod', 'Function')
hl('TSField', 'Identifier')
hl('TSProperty', 'Identifier')
hl('TSConstructor', 'Special')
hl('TSAnnotation', 'PreProc')
hl('TSAttribute', 'PreProc')
hl('TSNamespace', 'Include')
hl('TSConditional', 'Conditional')
hl('TSRepeat', 'Repeat')
hl('TSLabel', 'Label')
hl('TSOperator', 'Operator')
hl('TSKeyword', 'Keyword')
hl('TSKeywordFunction', 'Keyword')
hl('TSKeywordOperator', 'TSOperator')
hl('TSException', 'Exception')
hl('TSType', 'Type')
hl('TSTypeBuiltin', 'Type')
hl('TSInclude', 'Include')
hl('TSVariableBuiltin', 'Special')
hl('TSText', 'NonText')
