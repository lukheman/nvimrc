...
local hlk = require("utils").highlightlink
...
-- hlk('TSError', 'Error')
hlk('TSTitle', 'Title')
hlk('TSLiteral', 'String')
hlk('TSURI', 'Underlined')
hl('TSVariable', { fg=c.fg1 })
hlk('TSPunctDelimiter', 'Delimiter')
hlk('TSPunctBracket', 'Delimiter')
hlk('TSPunctSpecial', 'Delimiter')
hlk('TSConstant', 'Constant')
hlk('TSConstBuiltin', 'Special')
hlk('TSConstMacro', 'Define')
hlk('TSString', 'String')
hlk('TSStringRegex', 'String')
hlk('TSStringEscape', 'SpecialChar')
hlk('TSCharacter', 'Character')
hlk('TSNumber', 'Number')
hlk('TSBoolean', 'Boolean')
hlk('TSFloat', 'Float')
hlk('TSFunction', 'Function')
hlk('TSFuncBuiltin', 'Special')
hlk('TSFuncMacro', 'Macro')
hlk('TSParameter', 'Identifier')
hlk('TSParameterReference', 'TSParameter')
hlk('TSMethod', 'Function')
hlk('TSField', 'Identifier')
hlk('TSProperty', 'Identifier')
hlk('TSConstructor', 'Special')
hlk('TSAnnotation', 'PreProc')
hlk('TSAttribute', 'PreProc')
hlk('TSNamespace', 'Include')
hlk('TSConditional', 'Conditional')
hlk('TSRepeat', 'Repeat')
hlk('TSLabel', 'Label')
hlk('TSOperator', 'Operator')
hlk('TSKeyword', 'Keyword')
hlk('TSKeywordFunction', 'Keyword')
hlk('TSKeywordOperator', 'TSOperator')
hlk('TSException', 'Exception')
hlk('TSType', 'Type')
hlk('TSTypeBuiltin', 'Type')
hlk('TSInclude', 'Include')
hlk('TSVariableBuiltin', 'Special')
hlk('TSText', 'NonText')
hl('TSStrong', {gui='bold'})
hl('TSEmphasis', {gui='italic'})
hl('TSUnderline', {gui='underline'})
hlk('TSComment', 'Comment')
