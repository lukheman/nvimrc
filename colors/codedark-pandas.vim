...
let g:colors_name="codedark-pandas"
...
let s:cdGreen = {'gui': '#5D864A', 'cterm': s:cterm0B, 'cterm256': '65'}
...
call <sid>hi('CursorLineNr', s:cdNone, s:cdCursorDarkDark, 'none', {})
...
call <sid>hi('StorageClass', s:cdBlue, {}, 'italic', {})
