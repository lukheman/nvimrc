...
call forest_night#highlight('LineNr', s:palette.grey2, s:palette.bg2)
if (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background !=# 'default'
  ...
  call forest_night#highlight('CursorLineNr', s:palette.aqua, s:palette.bg1, 'bold')
endif
...
call forest_night#highlight('MatchParen', s:palette.red, s:palette.none)
...
call forest_night#highlight('Title', s:palette.fg, s:palette.none, 'bold')
...
call forest_night#highlight('String', s:palette.yellow, s:palette.none)
...
call forest_night#highlight('htmlH1', s:palette.fg, s:palette.none, 'bold')
call forest_night#highlight('htmlH2', s:palette.fg, s:palette.none, 'bold')
call forest_night#highlight('htmlH3', s:palette.fg, s:palette.none, 'bold')
call forest_night#highlight('htmlH4', s:palette.fg, s:palette.none, 'bold')
call forest_night#highlight('htmlH5', s:palette.fg, s:palette.none, 'bold')
call forest_night#highlight('htmlH6', s:palette.fg, s:palette.none, 'bold')
...
highlight! link htmlScriptTag Fg
